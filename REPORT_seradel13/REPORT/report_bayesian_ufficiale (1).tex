...
\fancyhead[C]{Coupled Markov chains with applications to Approximate Bayesian Computation for model based clustering $\bullet$ February 2022 }%$\bullet$} % Custom header text
