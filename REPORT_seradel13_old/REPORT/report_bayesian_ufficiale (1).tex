...
\begin{figure}[h!]
	...
	\caption{A Coupled chains for parameter $\mu$ }   %without parallelization?
...
\begin{figure}[h!]
	...
	\caption{Sampling from all the accepted parallelized chains for parameter $\mu$ }   %without parallelization?
...
\begin{figure}[h!]
	...
	\caption{histogram for parameter $\mu$: Sampling from all the accepted parallelized chains with estimated kernel}   %without parallelization?
	\label{muhistdouble}
\end{figure}
...
\begin{figure}[h!]
	...
	\caption{A Coupled chains for parameter $\sigma^2$ }   %without parallelization?
...
\begin{figure}[h!]
	...
	\caption{Sampling from all the accepted parallelized chains for parameter $\sigma^2$  }   %without parallelization?
...
\begin{figure}[h!]
	...
	\caption{histogram for parameter $\sigma^2$ : Sampling from all the accepted parallelized chains with estimated kernel}   %without parallelization?
